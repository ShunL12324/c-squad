...
func (m model) footer() []string {
	...
	if m.kind == "tasks" {
		hint = textStyle("←→", foreground, false) + textStyle(" Filter  ", muted, false) + textStyle("↵", foreground, false) + textStyle(" Details  ", muted, false) + textStyle("g", foreground, false) + textStyle(" Master", muted, false)
		if m.detail {
